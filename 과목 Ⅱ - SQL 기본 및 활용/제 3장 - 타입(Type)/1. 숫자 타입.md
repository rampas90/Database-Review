...
* MySQL 정수 타입에 따른 표현할 수 있는 최댓값, 최솟값과 요구되는 저장 공간의 크기는 다음과 같다.
  * <img src="../../images/2_21.PNG" width="600"/>
...
* 실행결과
  * <img src="../../images/2_22.PNG" width="600"/>
***
...
* 문법
  ...
  DECIMAL(M, D);
  ```
  **M** 은 소수 부분을 포함한 실수의 총 자릿수를 나타내며, 최댓값은 65이다. **D** 는 소수 부분의 자릿수를 나타내며, D가 0이면 소수 부분을 가지지 않는다.
...
* 실행결과
  * <img src="../../images/2_23.PNG" width="600"/>
...
* 실행결과
  * <img src="../../images/2_24.PNG" width="600"/>
  * 위의 예제에서 ROOMNUM 필드는 **-99999.99부터 99999.99** 까지의 실수를 저장할 수 있도록 변경된다.
...
* 실행결과
  * <img src="../../images/2_25.PNG" width="600"/>
